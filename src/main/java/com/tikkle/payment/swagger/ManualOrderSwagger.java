...
@Tag(name = "Manual Order", description = "수동 매수 승인/거절 API")
public interface ManualOrderSwagger {

    @SecurityRequirement(name = "bearerAuth")
    @Operation(summary = "수동 매수 승인", description = "대기 중인 결제 건에 대해 수동 매수를 승인하고 즉시 체결합니다.")
    ...
    @SecurityRequirement(name = "bearerAuth")
    @Operation(summary = "수동 매수 거절", description = "대기 중인 결제 건에 대해 수동 매수를 거절하고 투자를 스킵합니다.")
