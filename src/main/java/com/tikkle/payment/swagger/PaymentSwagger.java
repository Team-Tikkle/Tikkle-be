...
public interface PaymentSwagger {
    ...
    @ApiResponses({
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "수신 성공 (중복/카드불일치/잔돈0원/분류실패 건도 200으로 ActionType을 담아 응답). cleanMerchantName 필드는 AI 정제된 이름이 반환됩니다.",
                    content = @Content(mediaType = "application/json", examples = {
                            @ExampleObject(name = "정상 처리 (자동 투자)", value = "{ \"code\": \"SUCCESS\", \"message\": \"요청에 성공했습니다.\", \"data\": { \"actionType\": \"ORDER_REQUESTED\", \"cleanMerchantName\": \"스타벅스\", \"paymentAmount\": 4500, \"spareChange\": 5000, \"market\": \"KRW-BTC\", \"coinName\": \"비트코인\" } }"),
                            @ExampleObject(name = "AI 분류 실패/타임아웃 (조기 종료)", value = "{ \"code\": \"SUCCESS\", \"message\": \"요청에 성공했습니다.\", \"data\": { \"actionType\": \"IGNORE_CLASSIFICATION_FAILED\", \"cleanMerchantName\": \"스타벅스일산문화센터\", \"paymentAmount\": 4500, \"spareChange\": 0, \"market\": null, \"coinName\": null } }")
                    })),
