...
public enum PaymentStatus {
    ...
    CLASSIFYING,        // 1차 캐시 Miss 후, RabbitMQ + AI 워커가 카테고리 분류 중
    ...
    INVESTED,           // 증권사 API 매수 체결 완료 (최종 성공 상태)

    // [4단계: 예외 및 만료]
    FAILED,             // 매수 실패 (연동 계좌 잔액 부족, KIS 증권사 서버 에러 등)
    EXPIRED             // 수동 매매 대기 중 24시간이 지나 스케줄러에 의해 만료된 건
}